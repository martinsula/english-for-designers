...
### YouTube
YouTube will mainly be used to share short haircuts from the races, in the form of "highlite" and "aftermovie" videos, or to create so-called "Report videos" that introduce people through one person to the overall course of the races, their atmosphere, what happens around them and, for example, what happens behind the scenes. In the future, these videos can also be created through a popular or successful athlete, which would show the overall course of the races from his point of view as an athlete. Here we can also talk about so-called "Vlog videos". There is also room for collaboration with other YouTube channels or directly with YouTubers from the sports sector, who would increase the possibility of video reach, both in terms of viewership and especially in terms of attracting new followers of the sport.
![image](https://user-images.githubusercontent.com/73489631/119001621-6c643a80-b98c-11eb-8b8c-2e4264569d92.png)
